...
public class AttrController {
    ...
    public ResponseVo<List<AttrEntity>> queryAttrEntitiesByCategoryIdAndTypeOrSearchType(
            @PathVariable("cid")Long cid,
            @RequestParam(value = "type",required = false)Integer type,
            @RequestParam(value = "searchType",required = false)Integer searchType){
        List<AttrEntity> attrEntities=attrService.queryAttrEntitiesByCategoryIdAndTypeOrSearchType(cid,type,searchType);
    ...
    public ResponseVo<List<AttrEntity>> queryAttrEntitiesByAttrGroupId(@PathVariable("gid")Long gid){
