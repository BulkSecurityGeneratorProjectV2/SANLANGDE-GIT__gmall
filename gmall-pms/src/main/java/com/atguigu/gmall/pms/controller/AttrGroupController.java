...
public class AttrGroupController {
    ...
    public ResponseVo<List<AttrGroupEntity>> queryAttrs(@PathVariable("catId")Long catId){
        List<AttrGroupEntity> groupEntities = attrGroupService.queryAttrs(catId);
    ...
    public ResponseVo<List<AttrGroupEntity>> queryAttrGroupEntities(@PathVariable("cid") Long cid){
